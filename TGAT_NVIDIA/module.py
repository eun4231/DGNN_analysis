...
class TGAN(torch.nn.Module):
    def __init__(self, args, ngh_finder, n_feat, e_feat,
    ...
    def forward(self, src_idx_l, target_idx_l, cut_time_l, num_neighbors=20):
        ...
        with record_function("affinity score"):
    ...
    def tem_conv(self, src_idx_l, cut_time_l, curr_layers, num_neighbors=20):
        if(self.start_profiling):
            with record_function("tem_conv part1"):
                ...
                with record_function("TIME ENCODER"):
            ...
            if curr_layers == 0:
                ...
                with record_function("tem_conv part2"):
                ...
                src_ngh_node_conv_feat = self.tem_conv(src_ngh_node_batch_flat, 
                                                       ...
                                                       curr_layers=curr_layers - 1, 
                                                       num_neighbors=num_neighbors)
                with record_function("tem_conv part3"):
