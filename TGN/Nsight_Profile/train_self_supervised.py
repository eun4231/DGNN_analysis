...
parser.add_argument('--prefix', type=str, default='jodie_rnn', help='Prefix to name the checkpoints')
...
parser.add_argument('--embedding_module', type=str, default="time", choices=[
  "graph_attention", "graph_sum", "identity", "time"], help='Type of embedding module')
parser.add_argument('--message_function', type=str, default="identity", choices=[
  "mlp", "identity"], help='Type of message function')
parser.add_argument('--memory_updater', type=str, default="rnn", choices=[
...
for i in range(args.n_runs):
  ...
  # Initialize Model
  if args.gpu != -1: torch.cuda.nvtx.range_push("Initialize Model TGN") ## -----> PROFILING
  ...
  if args.gpu != -1: torch.cuda.nvtx.range_push("Test perdiction") ## -----> PROFILING
  ...
  if args.gpu != -1: torch.cuda.nvtx.range_push("eval_edge_prediction - " + str(len(test_data.sources)) ) ## -----> PROFILING
