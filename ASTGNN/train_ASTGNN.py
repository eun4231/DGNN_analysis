...
from utils2 import predict_and_save_results2 # modified function for inference analysis
...
DEVICE = torch.device('cuda:0') # could be tested with cpu
...
def predict_main(epoch, data_loader, data_target_tensor, _max, _min, type):
    ...
    predict_and_save_results2(net, data_loader, data_target_tensor, epoch, _max, _min, params_path, type)
